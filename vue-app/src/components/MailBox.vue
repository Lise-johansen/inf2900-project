            ...
            <div class="message-box">
                <div v-if="selectedConversation">
                    <div class="receiver-information">
                        ...
                        <h3> Price: {{ selectedConversation.item.price_per_day }}kr </h3>
                        </router-link>
                        <div class="card flex justify-content-center">
                            <Button type="button" icon="pi pi-equals" @click="toggle" aria-haspopup="true" aria-controls="overlay_menu" />
...
export default {
    components: {
        Image, Button, Dialog, Textarea, Menu
    },
    data() {
        return {
